...
### NEW! The **overall average tempo** of Jungle and Drum & Bass
...
The fast nature of these genres could be explained by the fact that all sounds and samples are played via an electronic device. Musicians could have trouble playing at this tempo because it would be very uncomfortable to play on an instrument that fast. But for these music genres, a DJ can easily **adjust the tempo by turning a button**. The electronic device has no trouble of any kind in speeding up or slowing down the samples that are played. This might be an important factor in why Jungle and Drum & Bass are at such a high tempo.
